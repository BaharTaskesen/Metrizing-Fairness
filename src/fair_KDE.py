...
# df_test.to_csv('results/{}_zafar_{}_test.csv'.format(args.dataset, 0))
    ...
    df_train.to_csv('results/FKDE/{}_FKDE_20_{}_train.csv'.format(args.dataset, args.seed))

    df_test.to_csv('results/FKDE/{}_FKDE_20_{}_test.csv'.format(args.dataset, args.seed))
    ...
    with open('results/{}_FKDE_20_{}.pkl'.format(args.dataset, args.seed), 'wb') as f:
